...
/**
 * Created by Guilherm Cunha on 03/03/16.
 */
...
public class TimeActivity extends Activity {
    ...
    private void initComponents() {
        ...
        tvTeamsTitle.setText(String.valueOf(numberTeams) + " " + getString(R.string.titulo_times));
    }
    ...
    private String printTeams(ArrayList<String> al, int numTeams) {
        ...
        for (int i = 0; i < numPlayers; i++) {
            ...
            team++;
            if (i < numPlayers - 1) {
                result += getString(R.string.label_time) + " " + team + ": " + players + "\n\n\n";
            }
            else {
                result += getString(R.string.label_time) + " " + team + ": " + players;
            }
