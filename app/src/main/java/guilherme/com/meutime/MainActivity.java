...
public class MainActivity extends FragmentActivity {
    ...
    private void initComponents() {
        ...
        sbUndo.applyStyle(R.style.SnackBarSingleLine);
               sbUndo.text(getString(R.string.delete_aviso))
    ...
    private void updatePlayersList() {
        ...
        tvPlayersCounter.setText(getString(R.string.numeroJogadores, String.valueOf(playersList.size())));
    }
    ...
    private void addPlayer() {
        ...
        if (name.length() > 0) {
            ...
            showAlert(getString(R.string.erro_nome_jogador));
        }
    }

    private void clearList() {
        if (playersList.size() == 0) {
            showAlert(getString(R.string.empty_lista));
        } else {
    ...
    private void createTeams() {
        if (playersList.size() < 4) {
            showAlert(getString(R.string.min_jogadores_aviso));
            ...
            builder.title(getString(R.string.titulo_numero_times))
                    .positiveAction(getString(R.string.ok_aviso))
                    .negativeAction(getString(R.string.cancelar_aviso))
